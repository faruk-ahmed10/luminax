...
const Stats = () => {
    ...
    return (
        <div className="w-full my-8 bg-dark-gray p-8 rounded-lg">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-5 pt-8">
                <div className="">
                    <h3 className="text-xs font-semibold text-dark-white/70 pb-2">Players</h3>
                    <div className="">
                ...
                <div className="">
                    <h3 className="text-xs font-semibold text-dark-white/70 pb-2">Total Value Locked</h3>
                    <div className="">
                ...
                <div className="">
                    <h3 className="text-xs font-semibold text-dark-white/70 pb-2">Rewards</h3>
                    <div className="">
                ...
                <div className="">
                    <h3 className="text-xs font-semibold text-dark-white/70 pb-2">Dividend Pool</h3>
                    <div className="">
                ...
                <div className="">
                    <h3 className="text-xs font-semibold text-dark-white/70 pb-2">Contract Balance</h3>
                    <div className="">
                ...
                <div className="">
                    <h3 className="text-xs font-semibold text-dark-white/70 pb-2">Transactions</h3>
                    <div className="">
