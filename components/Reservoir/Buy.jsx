        ...
        <div className="w-full rounded-lg bg-dark-gray p-8">
            ...
            <div className="w-full">
                ...
                <div className="w-full rounded-lg flex text-sm items-center overflow-hidden">
                    ...
                    <button className="px-2 py-2 bg-dark-sec hover:bg-dark-sec/80 border-2 border-dark-sec hover:dark-sec/80 text-dark">Auto slippage</button>
                </div>
            </div>
            <div className="pt-4">
            ...
            <button className="w-36 mt-5 xs:mt-3 bg-dark-sec hover:bg-transparent border-2 border-transparent hover:border-dark-pri px-7 py-2 text-dark-black focus:text-dark-white rounded-full font-bold">Buy</button>
        </div>
    )
}
