        ...
        <div className="w-full rounded-lg bg-dark-gray p-8">
            <div className="">
                ...
                <div className="w-full rounded-lg flex overflow-hidden">
                    <input type="text" name="" id="" className="outline-none rounded-l-lg border-y-2 border-l-2 border-dark-pri/40 focus:bg-dark/30 w-full bg-transparent py-2 px-2 text-xs placeholder:text-dark-pri/40" placeholder="Amount" />
                ...
                <div className="flex flex-col xs:flex-row justify-between gap-5">
                    <button className="bg-dark-sec hover:bg-transparent border-2 border-transparent  hover:border-dark-pri hover:text-dark-white px-7 py-2 text-dark-black rounded-full font-bold transition-all duration-200">Approve</button>
