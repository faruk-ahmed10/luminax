        ...
        <div className="w-full rounded-lg bg-dark-gray p-8 mt-8 lg:mt-0">
            ...
            <div className="">
                ...
                <div className="w-full rounded-lg flex text-sm items-center overflow-hidden">
                    <input type="number" className="w-full bg-dark-gray  rounded-l-lg border-l-2 font-medium text-dark-white border-y-2 border-dark-pri/40 flex-1 px-3 py-2 outline-none" />
                    <div className="percentage px-3 py-2 border-l border-y-2 border-dark-pri/40">%</div>
                    <button className="px-2 py-2 bg-dark-sec hover:bg-dark-sec/80 border-2 border-dark-sec text-dark">Auto slippage</button>
                </div>
            </div>
            <div className="pt-4">
                ...
                <div className="w-full rounded-lg flex text-sm items-center overflow-hidden">
                    <input type="number" className="w-full bg-dark-gray rounded-l-lg border-l-2 font-medium text-dark-white border-y-2 border-dark-pri/40 flex-1 px-3 py-2 outline-none" />
                    <button className="px-2 py-2 bg-dark-sec hover:bg-dark-sec/80 text-dark border-2 border-dark-sec">Max</button>
                </div>
            </div>
            ...
            <div className="xs:flex justify-between items-center">
                <button className="w-36 outline-none bg-dark-sec hover:bg-dark border-2 my-2 xs:my-0 border-transparent hover:border-dark-pri py-3 text-dark-black hover:text-dark-white font-bold rounded-full transition-all duration-200 ease-out">Sell LUMIX</button>
